...
const AboutContent = ({ values, history }: AboutContentProps) => {
    const getIcon = (iconName: string) => {
        switch (iconName) {
            case 'Shield': return <Shield className="w-8 h-8" />;
            case 'Award': return <Award className="w-8 h-8" />;
            case 'Users': return <Users className="w-8 h-8" />;
            case 'Lock': return <Shield className="w-8 h-8" />;
            case 'Target': return <Award className="w-8 h-8" />;
            case 'Eye': return <Users className="w-8 h-8" />;
